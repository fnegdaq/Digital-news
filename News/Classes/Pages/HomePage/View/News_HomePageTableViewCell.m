...
@implementation News_HomePageTableViewCell
...
{
    self.newsImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"picholder"]];
    ...
    _titleLabel.text = @"自己挖坑自己埋 买台MacBook远没有结束";
