...
-(void)makeNewBar
{
    ...
    if (!self.sortBtn) {
        ...
        [self.sortBtn setTitleColor:[UIColor colorWithRed:0.25098 green:0.6 blue:1.0 alpha:1] forState:0];
        ...
        self.sortBtn.layer.borderColor = [[UIColor colorWithRed:0.25098 green:0.6 blue:1.0 alpha:1] CGColor];
