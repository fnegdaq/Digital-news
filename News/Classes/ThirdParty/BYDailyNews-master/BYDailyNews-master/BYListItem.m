...
-(void)setItemName:(NSString *)itemName{
    ...
    [self setTitleColor:[UIColor colorWithRed:0.25098 green:0.6 blue:1.0 alpha:1] forState:0];
    self.titleLabel.font = [UIFont systemFontOfSize:kItemFont];
    self.layer.cornerRadius = 4;
    self.layer.borderColor = [[UIColor colorWithRed:0.25098 green:0.6 blue:1.0 alpha:1] CGColor];
...
-(void)changeFromTopToBottom{
    ...
    NSMutableArray * listTopArray = [userDefaults objectForKey:@"listTop"];
    NSMutableArray * anotherListTopArray = [NSMutableArray arrayWithArray:listTopArray];
    [anotherListTopArray removeObject:self.itemName];
    [userDefaults setObject:anotherListTopArray forKey:@"listTop"];
    NSMutableArray * listBottomArray = [userDefaults objectForKey:@"listBottom"];
    NSMutableArray * anotherListBottomArray = [NSMutableArray arrayWithArray:listBottomArray];
    [anotherListBottomArray addObject:self.itemName];
    [userDefaults setObject:anotherListBottomArray forKey:@"listBottom"];
    [locateView removeObject:self];
...
-(void)changeFromBottomToTop{
    NSUserDefaults * listUserDefauls = [NSUserDefaults standardUserDefaults];
    NSMutableArray * listTopArray = [listUserDefauls objectForKey:@"listTop"];
    NSMutableArray * anotherListTopArray = [NSMutableArray arrayWithArray:listTopArray];
    [anotherListTopArray addObject:self.itemName];
    [listUserDefauls setObject:anotherListTopArray forKey:@"listTop"];
    NSMutableArray * listBottomArray = [listUserDefauls objectForKey:@"listBottom"];
    NSMutableArray * anotherListBottomArray = [NSMutableArray arrayWithArray:listBottomArray];
    [anotherListBottomArray removeObject:self.itemName];
    [listUserDefauls setObject:anotherListBottomArray forKey:@"listBottom"];
    [locateView removeObject:self];
    [topView insertObject:self atIndex:topView.count];
    locateView = topView;
    self.location = top;
